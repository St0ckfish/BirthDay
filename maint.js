...
document.querySelector("#submit").addEventListener("click", () => {
    if (iname.value === "") document.querySelector("#req0").style.visibility = "visible"; else document.querySelector("#req0").style.visibility = "hidden";
    if (iday.value === "") document.querySelector("#req1").style.visibility = "visible"; else document.querySelector("#req1").style.visibility = "hidden";
    if (imonth.value === "") document.querySelector("#req2").style.visibility = "visible"; else document.querySelector("#req2").style.visibility = "hidden";
    if (iyear.value === "") document.querySelector("#req3").style.visibility = "visible"; else document.querySelector("#req3").style.visibility = "hidden";
    if (iday.value != "" && imonth.value != "" && iyear.value != "" && iname.value != "") {
        ...
        document.querySelector(".Birthday h1").innerHTML = `Hi ${iname.value}, Until Your ${cyearr + 1 - targetyear}st Birthday!`;
        document.querySelector(".Birthday").style.visibility = "visible";
        document.querySelector(".container").style.visibility = "visible";
